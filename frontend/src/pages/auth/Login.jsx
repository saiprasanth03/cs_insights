...
export default function Login() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center relative py-20 px-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-[500px] bg-brand-500/20 blur-[120px] rounded-full pointer-events-none" />
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-sm font-medium text-brand-600 dark:text-brand-400 hover:underline">Forgot password?</Link>
              </div>
              <div className="relative">
