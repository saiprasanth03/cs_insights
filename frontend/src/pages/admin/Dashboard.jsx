      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="glass rounded-3xl p-8 border border-gray-200/50 dark:border-gray-800/50 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            ...
            <Link to="/admin/newsletters" className="px-6 py-4 glass bg-gradient-to-r from-accent-violet to-brand-600 hover:from-brand-500 hover:to-accent-violet text-white rounded-2xl text-left font-medium transition-all hover:-translate-y-1 shadow-lg hover:shadow-xl">
              Article Delivery & Email Logs
            </Link>
            ...
            <Link to="/admin/comments" className="px-6 py-4 glass bg-white dark:bg-black/40 hover:bg-gray-50 dark:hover:bg-black/60 text-gray-900 dark:text-white rounded-2xl text-left font-medium transition-all hover:-translate-y-1 border border-gray-200/50 dark:border-gray-700/50">
              Manage Comments ({stats.totalComments ?? stats.pendingComments ?? 0})
            </Link>
